...
// const { syncSkills } = require('../index')
// const {
...
//   endpoint: process.env.ES_URL,
//   region: process.env.ES_REGION,
//   index: process.env.ES_SKILLS_INDEX,
//   doctype: process.env.ES_SKILLS_MAPPING
// }
...
// const endpoint = new AWS.Endpoint(process.env.ES_URL)
...
//     syncSkills(createEnteredSkillsEvent, context)
//     await waitJob()
...
//     syncSkills(updateEnteredSkillsEvent, context)
//     await waitJob()
...
//     syncSkills(deleteEnteredSkillsEvent, context)
//     await waitJob()
...
//     syncSkills(createMemberAggregatedSkillsEvent, context)
//     await waitJob()
//     should.equal(infoLogs[1], 'INSERT event listened')
//     // the status code should be 201 created
//     should.equal(infoLogs[2], 'Response status code: 201')
...
//     syncSkills(updateMemberAggregatedSkillsEvent, context)
//     await waitJob()
//     should.equal(infoLogs[1], 'MODIFY event listened')
//     should.equal(infoLogs[2], 'Response status code: 200')
...
//     syncSkills(deleteMemberAggregatedSkillsEvent, context)
//     await waitJob()
//     should.equal(infoLogs[1], 'REMOVE event listened')
//     should.equal(infoLogs[2], 'Response status code: 200')
